# DSC Configuration: XOAP_Citrix_StoreFront_W2K25
# Purpose: Configures Citrix StoreFront service and IIS prerequisites on Windows Server 2025.
Configuration 'XOAP_Citrix_StoreFront_W2K25'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DSCResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'

    Node 'XOAP_Citrix_StoreFront_W2K25'
    {
        ...
        # --- Registry: W2K25-specific TLS 1.3 enforcement ---
...
XOAP_Citrix_StoreFront_W2K25 -OutputPath 'C:\DSC\XOAP_Citrix_StoreFront_W2K25'
