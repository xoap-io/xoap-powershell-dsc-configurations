# DSC Configuration: XOAP_Citrix_UberAgent_W2K25
# Purpose: Installs and configures Citrix UberAgent on Windows Server 2025.
Configuration 'XOAP_Citrix_UberAgent_W2K25'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DscResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'

    Node 'XOAP_Citrix_UberAgent_W2K25'
    {
        ...
        # Registry: W2K25-specific: Use new ETW provider
...
XOAP_Citrix_UberAgent_W2K25 -OutputPath 'C:\DSC\XOAP_Citrix_UberAgent_W2K25'
