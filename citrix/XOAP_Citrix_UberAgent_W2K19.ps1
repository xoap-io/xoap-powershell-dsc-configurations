# DSC Configuration: XOAP_Citrix_UberAgent_W2K19
# Purpose: Installs and configures Citrix UberAgent on Windows Server 2019.
Configuration 'XOAP_Citrix_UberAgent_W2K19'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DSCResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'

    Node 'XOAP_Citrix_UberAgent_W2K19'
    {
...
XOAP_Citrix_UberAgent_W2K19 -OutputPath 'C:\DSC\XOAP_Citrix_UberAgent_W2K19'
