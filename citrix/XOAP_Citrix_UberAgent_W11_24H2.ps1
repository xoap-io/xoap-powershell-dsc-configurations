# DSC Configuration: XOAP_Citrix_UberAgent_W11_24H2
# Purpose: Installs and configures Citrix UberAgent on Windows 11 24H2.
Configuration 'XOAP_Citrix_UberAgent_W11_24H2'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DscResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'

    Node 'XOAP_Citrix_UberAgent_W11_24H2'
    {
        ...
        # Registry: W11 24H2-specific: Use new ETW provider
        Registry 'UberAgent_UseETW'
        {
            Key       = 'HKEY_LOCAL_MACHINE\SOFTWARE\Citrix\UberAgent\ETW'
            Ensure    = 'Present'
            ValueName = 'UseModernProvider'
            ValueType = 'Dword'
            ValueData = '1'
        }
...
XOAP_Citrix_UberAgent_W11_24H2 -OutputPath 'C:\DSC\XOAP_Citrix_UberAgent_W11_24H2'
