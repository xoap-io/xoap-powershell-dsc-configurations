Configuration 'XOAP_W11_23H2_Citrix_Optimizer'
{
    ...
    Node 'XOAP_W11_23H2_Citrix_Optimizer'
    {
        # Windows 11 23H2: Citrix optimizer settings
        # Based on XOAP_W11_24H2_Citrix_Optimizer with 23H2-specific adjustments
        ...
        # --- 23H2-specific: Disable Copilot (not yet in W11 2009) ---
...
XOAP_W11_23H2_Citrix_Optimizer -OutputPath 'C:\DSC\XOAP_W11_23H2_Citrix_Optimizer'
