Configuration 'XOAP_W2K16_1607_Citrix_Optimizer'
{
    ...
    Node 'XOAP_W2K16_1607_Citrix_Optimizer'
    {
        ...
        $services = @(
            'AJRouter','ALG','bthserv','Browser','DPS','WdiServiceHost','WdiSystemHost','MapsBroker','EFS','fdPHost','FDResPub','UI0Detect','SharedAccess','CscService','SstpSvc','SensrSvc','SSDPSRV','upnphost','icssvc','XblAuthManager','XblGameSave','SysMain','Themes','WerSvc','WSearch','DiagTrack','ShellHWDetection'
        )
        ...
        $scheduledTasks = @(
            ...
            @{Name='SmartScreenSpecific';Path='\Microsoft\Windows\AppID'},
        ...
        # Enable NTFS Last Access Update
