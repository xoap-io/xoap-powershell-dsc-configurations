# DSC Configuration: XOAP_Citrix_Session_Recording_Agent_W2K22
# Purpose: Configures Citrix Session Recording Agent on Windows Server 2022 session hosts.
Configuration 'XOAP_Citrix_Session_Recording_Agent_W2K22'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DSCResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'

    Node 'XOAP_Citrix_Session_Recording_Agent_W2K22'
    {
...
XOAP_Citrix_Session_Recording_Agent_W2K22 -OutputPath 'C:\DSC\XOAP_Citrix_Session_Recording_Agent_W2K22'
