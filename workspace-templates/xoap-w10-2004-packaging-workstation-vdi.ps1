Configuration 'xoap-w10-2004-packaging-workstation-vdi'
{
    ...
    Node "xoap-w10-2004-packaging-workstation-vdi"
    {
        ...
        XOAPVdiOptimizeMeta "XOAPVdiOptimizeW10Ent2004EnDSC Config" {
        ...
        XOAPPackageInstaller 'infraxo Application Install'
        {
            Id = [GUID]::NewGuid()
            InstallationScope = 'Host'
            PackageManagementUrl = '%%PackageManagementUrl%%'
            ConfigurationManagementUrl = '%%ConfigurationManagementUrl%%'
        }
        
        XOAPMonitor 'infraxo Monitoring'
        {
            Url = '%%ConfigurationManagementUrl%%/'
        }
