# DSC Configuration: XOAP_Debloat_W11_24H2_Privacy
# Purpose: Disables machine-wide telemetry, diagnostic data collection, advertising ID, and error reporting for Windows 11 24H2.
Configuration 'XOAP_Debloat_W11_24H2_Privacy'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DscResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'

    Node 'XOAP_Debloat_W11_24H2_Privacy'
    {
...
XOAP_Debloat_W11_24H2_Privacy -OutputPath 'C:\DSC\XOAP_Debloat_W11_24H2_Privacy'
