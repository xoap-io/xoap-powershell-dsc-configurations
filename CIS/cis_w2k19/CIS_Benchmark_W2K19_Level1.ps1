# DSC Configuration: CIS_Benchmark_W2K19_Level1
# Purpose: Applies CIS Benchmark Level 1 for Windows Server 2019.
Configuration 'CIS_Benchmark_W2K19_Level1'
{
    ...
    Node 'CIS_Benchmark_W2K19_Level1'
    {
...
CIS_Benchmark_W2K19_Level1 -OutputPath 'C:\DSC\CIS_Benchmark_W2K19_Level1'
