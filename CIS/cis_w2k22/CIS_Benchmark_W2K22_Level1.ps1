# DSC Configuration: CIS_Benchmark_W2K22_Level1
# Purpose: Applies CIS Benchmark Level 1 for Windows Server 2022.
Configuration 'CIS_Benchmark_W2K22_Level1'
{
    ...
    Node 'CIS_Benchmark_W2K22_Level1'
    {
...
CIS_Benchmark_W2K22_Level1 -OutputPath 'C:\DSC\CIS_Benchmark_W2K22_Level1'
