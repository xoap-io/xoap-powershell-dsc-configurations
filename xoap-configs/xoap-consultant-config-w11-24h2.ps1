# DSC Configuration: xoap-consultant-config-w11-24h2
# Purpose: XOAP consultant workstation configuration for Windows 11 24H2.
Configuration 'xoap-consultant-config-w11-24h2'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DscResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'

    Node 'xoap-consultant-config-w11-24h2'
    {
...
xoap-consultant-config-w11-24h2 -OutputPath 'C:\DSC\xoap-consultant-config-w11-24h2'
