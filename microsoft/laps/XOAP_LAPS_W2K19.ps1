# DSC Configuration: XOAP_LAPS_W2K19
# Purpose: Configures Modern Windows LAPS (Local Administrator Password Solution) policy for Windows Server 2019.
Configuration 'XOAP_LAPS_W2K19'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'

    Node 'XOAP_LAPS_W2K19'
    {
...
XOAP_LAPS_W2K19 -OutputPath 'C:\DSC\XOAP_LAPS_W2K19'
