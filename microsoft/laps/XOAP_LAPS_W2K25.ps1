# DSC Configuration: XOAP_LAPS_W2K25
# Purpose: Configures Modern Windows LAPS (Local Administrator Password Solution) policy for Windows Server 2025.
Configuration 'XOAP_LAPS_W2K25'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'

    Node 'XOAP_LAPS_W2K25'
    {
        ...
        # --- Windows LAPS: Encrypted Password (W2K25 supports encrypted backup) ---
        Registry 'LAPS_ADEncryptedPasswordHistory'
        {
            Key       = 'HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\LAPS'
            Ensure    = 'Present'
...
XOAP_LAPS_W2K25 -OutputPath 'C:\DSC\XOAP_LAPS_W2K25'
