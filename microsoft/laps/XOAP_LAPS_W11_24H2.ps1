# DSC Configuration: XOAP_LAPS_W11_24H2
# Purpose: Configures Modern Windows LAPS (Local Administrator Password Solution) policy for Windows 11 24H2.
Configuration 'XOAP_LAPS_W11_24H2'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'

    Node 'XOAP_LAPS_W11_24H2'
    {
...
XOAP_LAPS_W11_24H2 -OutputPath 'C:\DSC\XOAP_LAPS_W11_24H2'
