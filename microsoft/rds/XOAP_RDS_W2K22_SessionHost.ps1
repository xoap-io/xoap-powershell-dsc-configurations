# DSC Configuration: XOAP_RDS_W2K22_SessionHost
# Purpose: Configures a Windows Server 2022 Remote Desktop Session Host.
Configuration 'XOAP_RDS_W2K22_SessionHost'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DscResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'
    Import-DscResource -ModuleName 'SecurityPolicyDSC'     -ModuleVersion '2.10.0.0'

    Node 'XOAP_RDS_W2K22_SessionHost'
    {
        # --- Windows Features ---
...
XOAP_RDS_W2K22_SessionHost -OutputPath 'C:\DSC\XOAP_RDS_W2K22_SessionHost'
