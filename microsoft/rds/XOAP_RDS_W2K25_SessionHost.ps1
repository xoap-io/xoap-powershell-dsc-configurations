# DSC Configuration: XOAP_RDS_W2K25_SessionHost
# Purpose: Configures a Windows Server 2025 Remote Desktop Session Host.
Configuration 'XOAP_RDS_W2K25_SessionHost'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DscResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'
    Import-DscResource -ModuleName 'SecurityPolicyDSC'     -ModuleVersion '2.10.0.0'

    Node 'XOAP_RDS_W2K25_SessionHost'
    {
        # --- Windows Features ---
        ...
        # W2K25-specific: Enable SMB over QUIC for session host file access
        Registry 'RDS_W2K25_SMBQUICClient'
        {
        ...
        # W2K25-specific: LSA PPL level 2 (UEFI locked)
        Registry 'RDS_W2K25_LSA_PPL'
        {
...
XOAP_RDS_W2K25_SessionHost -OutputPath 'C:\DSC\XOAP_RDS_W2K25_SessionHost'
