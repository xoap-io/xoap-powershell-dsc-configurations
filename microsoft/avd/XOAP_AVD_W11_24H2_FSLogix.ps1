# DSC Configuration: XOAP_AVD_W11_24H2_FSLogix
# Purpose: Configures FSLogix profile containers for Windows 11 24H2 AVD session hosts.
Configuration 'XOAP_AVD_W11_24H2_FSLogix'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DscResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'

    Node 'XOAP_AVD_W11_24H2_FSLogix'
    {
        # FSLogix service
        Service 'FrxSvc'
        {
...
XOAP_AVD_W11_24H2_FSLogix -OutputPath 'C:\DSC\XOAP_AVD_W11_24H2_FSLogix'
