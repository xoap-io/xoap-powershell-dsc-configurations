# DSC Configuration: XOAP_AVD_W11_24H2_SessionHost
# Purpose: Configures a Windows 11 24H2 Azure Virtual Desktop session host.
Configuration 'XOAP_AVD_W11_24H2_SessionHost'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DscResource -ModuleName 'ComputerManagementDsc' -ModuleVersion '10.0.0'
    Import-DscResource -ModuleName 'GPRegistryPolicyDsc'   -ModuleVersion '1.2.0'

    Node 'XOAP_AVD_W11_24H2_SessionHost'
    {
        # --- Windows Features ---
        ...
        # --- Disable Windows Recall on session host ---
...
XOAP_AVD_W11_24H2_SessionHost -OutputPath 'C:\DSC\XOAP_AVD_W11_24H2_SessionHost'
