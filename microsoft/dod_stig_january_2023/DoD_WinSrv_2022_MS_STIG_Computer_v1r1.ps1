...
Configuration DoD_WinSrv_2022_MS_STIG_Computer_v1r1
{
	...
	Node DoD_WinSrv_2022_MS_STIG_Computer_v1r1
	{
         ...
         UserRightsAssignment 'UserRightsAssignment(INF): Deny_access_to_this_computer_from_the_network'
         {
              ...
              Force = $True
              Identity = @('*S-1-5-114', '*S-1-5-32-546', 'ADD YOUR ENTERPRISE ADMINS', 'ADD YOUR DOMAIN ADMINS')
         }
