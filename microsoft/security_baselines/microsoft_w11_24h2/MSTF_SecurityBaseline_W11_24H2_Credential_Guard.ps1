# DSC Configuration: MSTF_SecurityBaseline_W11_24H2_Credential_Guard
# Purpose: Enables Virtualization-Based Security and Credential Guard for Windows 11 24H2.
Configuration 'MSTF_SecurityBaseline_W11_24H2_Credential_Guard'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DSCResource -ModuleName 'GPRegistryPolicyDsc' -ModuleVersion '1.2.0'

    Node 'MSTF_SecurityBaseline_W11_24H2_Credential_Guard'
    {
        ...
        RegistryPolicyFile 'CredentialGuard_DefaultEnabled'
        {
            ValueName  = 'CredentialGuard'
            ValueData  = 1
            ValueType  = 'Dword'
            TargetType = 'ComputerConfiguration'
            Key        = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard'
...
MSTF_SecurityBaseline_W11_24H2_Credential_Guard -OutputPath 'C:\DSC\MSTF_SecurityBaseline_W11_24H2_Credential_Guard'
