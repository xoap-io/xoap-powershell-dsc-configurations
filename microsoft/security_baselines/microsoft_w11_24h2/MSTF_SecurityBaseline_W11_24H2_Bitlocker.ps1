# DSC Configuration: MSTF_SecurityBaseline_W11_24H2_Bitlocker
# Purpose: Applies BitLocker and device installation restrictions for Windows 11 24H2.
Configuration 'MSTF_SecurityBaseline_W11_24H2_Bitlocker'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DSCResource -ModuleName 'GPRegistryPolicyDsc' -ModuleVersion '1.2.0'

    Node 'MSTF_SecurityBaseline_W11_24H2_Bitlocker'
    {
...
MSTF_SecurityBaseline_W11_24H2_Bitlocker -OutputPath 'C:\DSC\MSTF_SecurityBaseline_W11_24H2_Bitlocker'
