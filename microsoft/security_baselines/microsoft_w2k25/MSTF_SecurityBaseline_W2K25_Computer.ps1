# DSC Configuration: MSTF_SecurityBaseline_W2K25_Computer
# Purpose: Applies Microsoft Security Baseline computer policies for Windows Server 2025.
Configuration 'MSTF_SecurityBaseline_W2K25_Computer'
{
    ...
    Node 'MSTF_SecurityBaseline_W2K25_Computer'
    {
        # --- Account Policies ---
...
MSTF_SecurityBaseline_W2K25_Computer -OutputPath 'C:\DSC\MSTF_SecurityBaseline_W2K25_Computer'
