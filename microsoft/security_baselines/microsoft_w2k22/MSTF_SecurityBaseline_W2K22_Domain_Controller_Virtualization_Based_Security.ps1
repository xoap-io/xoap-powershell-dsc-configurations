...
Configuration MSTF_SecurityBaseline_W2K22_Domain_Controller_Virtualization_Based_Security
{
	...
	Node MSTF_SecurityBaseline_W2K22_Domain_Controller_Virtualization_Based_Security
	{
