...
Configuration MSTF_SecurityBaseline_W10_1507_IE11
{
	...
	Node MSTF_SecurityBaseline_W10_1507_IE11
	{
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3\2100'
         {
              ValueName = '2100'
              ValueData = 0
              ValueType = 'Dword'
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\4\2100'
         {
              ValueName = '2100'
              ValueData = 0
              ValueType = 'Dword'
