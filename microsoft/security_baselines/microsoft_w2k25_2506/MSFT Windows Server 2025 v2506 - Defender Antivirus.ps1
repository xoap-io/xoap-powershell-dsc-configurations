...
Configuration 'MSTF_SecurityBaseline_W2K25_2506_Defender_Antivirus'
{

	Import-DSCResource -ModuleName 'GPRegistryPolicyDsc'
	Import-DSCResource -ModuleName 'AuditPolicyDSC'
	Import-DSCResource -ModuleName 'SecurityPolicyDSC'
	Node 'MSTF_SecurityBaseline_W2K25_2506_Defender_Antivirus'
	{
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows Defender\SignaturesRing'
         {
              ValueName = 'SignaturesRing'
              ValueData = 5
              ValueType = 'Dword'
              TargetType = 'ComputerConfiguration'
              Key = 'HKLM:\Software\Policies\Microsoft\Windows Defender'
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows Defender\EngineRing'
         {
              ValueName = 'EngineRing'
              ValueData = 5
              ValueType = 'Dword'
              TargetType = 'ComputerConfiguration'
              Key = 'HKLM:\Software\Policies\Microsoft\Windows Defender'
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows Defender\PlatformRing'
         {
              ValueName = 'PlatformRing'
              ValueData = 5
              ValueType = 'Dword'
              TargetType = 'ComputerConfiguration'
              Key = 'HKLM:\Software\Policies\Microsoft\Windows Defender'
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules\a8f5898e-1dc8-49a9-9878-85004b8a61e6'
         {
              ValueName = 'a8f5898e-1dc8-49a9-9878-85004b8a61e6'
              ValueData = '1'
              ValueType = 'String'
              TargetType = 'ComputerConfiguration'
              Key = 'HKLM:\Software\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules'
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\Network Protection\AllowNetworkProtectionOnWinServer'
         {
...
MSTF_SecurityBaseline_W2K25_2506_Defender_Antivirus -OutputPath 'C:\DSC\MSTF_SecurityBaseline_W2K25_2506_Defender_Antivirus'
