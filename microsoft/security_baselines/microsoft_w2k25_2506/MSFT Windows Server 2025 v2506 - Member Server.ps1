...
Configuration 'MSTF_SecurityBaseline_W2K25_2506_Member_Server'
{
	...
	Node 'MSTF_SecurityBaseline_W2K25_2506_Member_Server'
	{
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System\Kerberos\Parameters\PKInitHashAlgorithmConfigurationEnabled'
         {
              ValueName = 'PKInitHashAlgorithmConfigurationEnabled'
              ValueData = 1
              ValueType = 'Dword'
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System\Kerberos\Parameters\PKInitSHA1'
         {
              ValueName = 'PKInitSHA1'
              ValueData = 1
              ValueType = 'Dword'
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System\Kerberos\Parameters\PKInitSHA256'
         {
              ValueName = 'PKInitSHA256'
              ValueData = 3
              ValueType = 'Dword'
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System\Kerberos\Parameters\PKInitSHA384'
         {
              ValueName = 'PKInitSHA384'
              ValueData = 3
              ValueType = 'Dword'
         ...
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System\Kerberos\Parameters\PKInitSHA512'
         {
              ValueName = 'PKInitSHA512'
              ValueData = 3
              ValueType = 'Dword'
         ...
         #>
         RegistryPolicyFile 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows NT\DNSClient\DnsPolicyConfig\'
         {
              ValueName = ''
              TargetType = 'ComputerConfiguration'
              Key = 'HKLM:\Software\Policies\Microsoft\Windows NT\DNSClient\DnsPolicyConfig'
         }
