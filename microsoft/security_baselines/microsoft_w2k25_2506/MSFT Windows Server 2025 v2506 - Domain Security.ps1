...
Configuration 'MSTF_SecurityBaseline_W2K25_2506_Domain_Security'
{

	Import-DSCResource -ModuleName 'GPRegistryPolicyDsc'
	Import-DSCResource -ModuleName 'AuditPolicyDSC'
	Import-DSCResource -ModuleName 'SecurityPolicyDSC'
	Node 'MSTF_SecurityBaseline_W2K25_2506_Domain_Security'
	{
...
MSTF_SecurityBaseline_W2K25_2506_Domain_Security -OutputPath 'C:\DSC\MSTF_SecurityBaseline_W2K25_2506_Domain_Security'
