# DSC Configuration: MSTF_SecurityBaseline_W2K19_Computer
# Purpose: Applies Microsoft Security Baseline for Windows Server 2019.
﻿
Configuration 'MSTF_SecurityBaseline_W2K19_Computer'
{
	...
	Node 'MSTF_SecurityBaseline_W2K19_Computer'
	{
...
MSTF_SecurityBaseline_W2K19_Computer -OutputPath 'C:\DSC\MSTF_SecurityBaseline_W2K19_Computer'
