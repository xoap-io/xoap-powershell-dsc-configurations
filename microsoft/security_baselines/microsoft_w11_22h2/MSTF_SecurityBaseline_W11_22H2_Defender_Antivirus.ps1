...
# DSC Configuration: MSTF_SecurityBaseline_W11_22H2_Defender_Antivirus
# Purpose: Applies Defender Antivirus security baseline settings for Windows 11 22H2.
Configuration 'MSTF_SecurityBaseline_W11_22H2_Defender_Antivirus'
{
    ...
    Node 'MSTF_SecurityBaseline_W11_22H2_Defender_Antivirus'
    {
        ...
        # Sets cloud block level for Defender
        ...
        # Enables removable drive scanning
        ...
        # Sets sample submission consent
        ...
        # Enables ASR rules for Exploit Guard
        ...
        # Enables network protection for Defender Exploit Guard
        RegistryPolicyFile 'ASR_75668c1f-73b5-4cf0-bb93-3ecf5cb7cc84'
        {
        ...
        # Enables ASR rule: 3b576869-a4ec-4529-8536-b80a7769e899
        RegistryPolicyFile 'ASR_3b576869-a4ec-4529-8536-b80a7769e899'
        {
        ...
        # Enables ASR rule: d4f940ab-401b-4efc-aadc-ad5f3c50688a
        RegistryPolicyFile 'ASR_d4f940ab-401b-4efc-aadc-ad5f3c50688a'
        {
        ...
        # Enables ASR rule: 92E97FA1-2EDF-4476-BDD6-9DD0B4DDDC7B
        RegistryPolicyFile 'ASR_92E97FA1-2EDF-4476-BDD6-9DD0B4DDDC7B'
        {
        ...
        # Enables ASR rule: 5beb7efe-fd9a-4556-801d-275e5ffc04cc
        RegistryPolicyFile 'ASR_5beb7efe-fd9a-4556-801d-275e5ffc04cc'
        {
        ...
        # Enables ASR rule: d3e037e1-3eb8-44c8-a917-57927947596d
        RegistryPolicyFile 'ASR_d3e037e1-3eb8-44c8-a917-57927947596d'
        {
        ...
        # Enables ASR rule: be9ba2d9-53ea-4cdc-84e5-9b1eeee46550
        RegistryPolicyFile 'ASR_be9ba2d9-53ea-4cdc-84e5-9b1eeee46550'
        {
        ...
        # Enables ASR rule: 9e6c4e1f-7d60-472f-ba1a-a39ef669e4b2
        RegistryPolicyFile 'ASR_9e6c4e1f-7d60-472f-ba1a-a39ef669e4b2'
        {
        ...
        # Enables ASR rule: b2b3f03d-6a65-4f7b-a9c7-1c7ef74a9ba4
        RegistryPolicyFile 'ASR_b2b3f03d-6a65-4f7b-a9c7-1c7ef74a9ba4'
        {
        ...
        # Enables ASR rule: 26190899-1602-49e8-8b27-eb1d0a1ce869
        RegistryPolicyFile 'ASR_26190899-1602-49e8-8b27-eb1d0a1ce869'
        {
        ...
        # Enables ASR rule: 7674ba52-37eb-4a4f-a9a1-f0f9a1619a2c
        RegistryPolicyFile 'ASR_7674ba52-37eb-4a4f-a9a1-f0f9a1619a2c'
        {
        ...
        # Enables ASR rule: c1db55ab-c21a-4637-bb3f-a12568109d35
        RegistryPolicyFile 'ASR_c1db55ab-c21a-4637-bb3f-a12568109d35'
        {
        ...
        # Enables ASR rule: e6db77e5-3df2-4cf1-b95a-636979351e5b
        RegistryPolicyFile 'ASR_e6db77e5-3df2-4cf1-b95a-636979351e5b'
        {
        ...
        # Enables ASR rule: 56a863a9-875e-4185-98a7-b882c64b5ce5
        RegistryPolicyFile 'ASR_56a863a9-875e-4185-98a7-b882c64b5ce5'
        {
