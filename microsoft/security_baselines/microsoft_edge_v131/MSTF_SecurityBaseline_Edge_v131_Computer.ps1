# DSC Configuration: MSTF_SecurityBaseline_Edge_v131_Computer
# Purpose: Applies Microsoft Security Baseline for Microsoft Edge v131.
Configuration 'MSTF_SecurityBaseline_Edge_v131_Computer'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DSCResource -ModuleName 'GPRegistryPolicyDsc' -ModuleVersion '1.2.0'

    Node 'MSTF_SecurityBaseline_Edge_v131_Computer'
    {
        # --- SmartScreen ---
        ...
        # --- Edge 131+: Enhanced Security Mode ---
        RegistryPolicyFile 'Edge_EnhancedSecurityMode'
        {
            ValueName  = 'EnhancedSecurityMode'
            ValueData  = 1
            ValueType  = 'Dword'
            TargetType = 'ComputerConfiguration'
            Key        = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
        ...
        # --- Edge 131+: Disable Copilot in Edge ---
        RegistryPolicyFile 'Edge_DisableCopilot'
        {
        ...
        # --- Edge 131+: Disable Shopping Features ---
        RegistryPolicyFile 'Edge_DisableShopping'
        {
...
MSTF_SecurityBaseline_Edge_v131_Computer -OutputPath 'C:\DSC\MSTF_SecurityBaseline_Edge_v131_Computer'
