# DSC Configuration: MSTF_SecurityBaseline_W11_23H2_Defender_Antivirus
# Purpose: Applies Windows Defender Antivirus baseline policies for Windows 11 23H2.
Configuration 'MSTF_SecurityBaseline_W11_23H2_Defender_Antivirus'
{
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration'
    Import-DSCResource -ModuleName 'GPRegistryPolicyDsc' -ModuleVersion '1.2.0'

    Node 'MSTF_SecurityBaseline_W11_23H2_Defender_Antivirus'
    {
...
MSTF_SecurityBaseline_W11_23H2_Defender_Antivirus -OutputPath 'C:\DSC\MSTF_SecurityBaseline_W11_23H2_Defender_Antivirus'
