# DSC Configuration: MSTF_SecurityBaseline_W11_23H2_Computer
# Purpose: Applies Microsoft Security Baseline computer policies for Windows 11 23H2.
Configuration 'MSTF_SecurityBaseline_W11_23H2_Computer'
{
    ...
    Node 'MSTF_SecurityBaseline_W11_23H2_Computer'
    {
        # --- Account Policies ---
...
MSTF_SecurityBaseline_W11_23H2_Computer -OutputPath 'C:\DSC\MSTF_SecurityBaseline_W11_23H2_Computer'
